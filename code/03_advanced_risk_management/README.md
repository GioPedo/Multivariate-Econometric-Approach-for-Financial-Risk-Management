...
This section extends the portfolio analysis with risk metrics, focusing on the dynamic estimation of Value at Risk (VaR) and Expected Shortfall (ES) using a VAR(1)-DCC-GARCH(1,1) framework.
